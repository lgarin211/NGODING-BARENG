...
<body>
	...
	<div class="container mx-auto jumbotron">
				...
				<div class="card shadow-sm">
					<div class="card-header">
						...
						<div class="row">
							...
							<div class="card">
								<img width="400px" class="img-fluid img-thumbnail rounded float-right" height="350px" src="<?= $itm->IMG_link; ?>" alt="">
